...
server.tool("get-sarcastic-joke", "Get a random sarcastic joke from a specific category", {
    category: z.enum(["programming", "work", "technology", "life"]).describe("The category of sarcastic joke to retrieve"),
}, async ({ category }) => {
...
server.tool("get-multiple-jokes", "Get multiple sarcastic jokes from a specific category", {
    category: z.enum(["programming", "work", "technology", "life"]).describe("The category of sarcastic jokes to retrieve"),
    count: z.number().min(1).max(5).describe("Number of jokes to retrieve (1-5)"),
...
server.tool("get-random-category-joke", "Get a random sarcastic joke from any category", {}, async () => {
...
server.tool("list-categories", "List all available joke categories", {}, async () => {
    const categories = Object.keys(sarcasticJokes);
